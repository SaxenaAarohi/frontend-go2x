      ...
      <section className="mb-20 text-center md:text-left flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-start">
            ...
            <button className="btn-outline text-lg px-8 py-4">Join 1v1 Challenge</button>
          </div>
        </div>
        <div className="flex-1 relative">
          ...
          <img 
            ...
            alt="Hero" 
            className="rounded-2xl border-2 border-zinc-800 shadow-2xl shadow-brand/20 rotate-3 hover:rotate-0 transition-transform duration-500"
